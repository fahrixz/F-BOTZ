...
module.exports = {
    async handler(chatUpdate) {
        ...
        try {
            ...
            if (opts['gconly'] && !m.fromMe && !m.chat.endsWith('g.us')) return await conn.sendMessage(m.chat, { text: "*Maaf kak*\nReel Bot Tidak Bisa Digunakan digunakan di private chat\n\n_Hanya Bisa Digunakan Di Dalam Group_\n\nKlik bergabung ke grup\nJika Ingin Menggunakan Bot Ini.",   contextInfo: { externalAdReply: { showAdAttribution: true, title: "GROUP ONLY MODE",  body: wm,   thumbnailUrl: "https://telegra.ph/file/485ace354ab59724fb0ca.jpg", sourceUrl: sgc, mediaType: 1,   renderLargerThumbnail: true }}}, { quoted: m})
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                       this.reply(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}shop buy limit*\nAtau Ketik ${usedPrefix}gethadiah Untuk Mendapatkan limit tambahan`, m)
...
global.dfail = (type, m, conn) => {
    let reelthumb = 'https://telegra.ph/file/4695e6aab8e920e6ab031.jpg'
    let msg = {
