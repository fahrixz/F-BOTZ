...
let handler = async (m, { conn }) => {
  let pepe = 'https://telegra.ph/file/49a2ebfc60eb3c95794ee.jpg'
  let baper = await fetch(pepe).then(a => a.buffer())

  let dann = '6285769727113@s.whatsapp.net'
  let a = await conn.profilePictureUrl(conn.user.jid, 'image').catch((_) => "https://telegra.ph/file/49a2ebfc60eb3c95794ee.jpg")
...
https://chat.whatsapp.com/FnvBeic1Qff2tW1eUBDhX4
